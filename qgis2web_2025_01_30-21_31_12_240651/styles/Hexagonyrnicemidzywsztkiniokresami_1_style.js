...
var style_Hexagonyrnicemidzywsztkiniokresami_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    
    var labelText = ""; var value = feature.get("Hexagony_roznica_wszystkie");
    ...
    if (value >= -172.685886 && value <= -95.995310) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -95.995310 && value <= -51.683817) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -51.683817 && value <= -17.322226) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -17.322226 && value <= 16.775890) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 16.775890 && value <= 60.402964) {
            style = [ new ol.style.Style({
